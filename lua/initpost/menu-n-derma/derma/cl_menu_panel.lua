...
local splasheh = {
    ...
    'HOP ON EUROGRAD',
    'NO SENPAI ARIGATO',
    'TWOMAD IS POSSESSING EUROGRAD',
    'A STRAIGHT BANANA',
    'JOHN EUROGRAD',
    'EUROCRACK',
    'PLAYING ON GRAD AND SMOKING SOME CRACK',
    'MONARCHY IS WHEN FEEDING THE CATS',
    'SURVIVAL INSTINCTS OF GIOVY',
    'BRR BRR BATA PIM',
    'MY QUOTE WAS KINDA GOOD NGL',
    'BETTER THA.. GO PLAY VCITY AND VOTTURZ ASWELL',
    'APHEX TWIN',
    'PLEASE KARMA RESET',
    'SERVER CRASHED',
}
