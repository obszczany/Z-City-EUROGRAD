...
hg.settings:AddOpt("Gameplay","eurograd_finisher_prompt", "Execution prompt")
...
hg.settings:AddOpt("Optimization","player_render_enabled", "Occlusion-based player rendering", nil, nil, "bool")
hg.settings:AddOpt("Optimization","player_render_full_hide", "Fully hide occluded players", nil, nil, "bool")
hg.settings:AddOpt("Optimization","player_render_checks_per_frame", "Player visibility checks per frame", nil, nil, "int")
